...
class WalletActivity extends NfcReaderActivity with ScanActivity { me =>
  ...
  val tokensPrice = MilliSatoshi(5000000L)
  ...
  def makeSettingsForm = {
    ...
    exportWalletSnapshot setOnClickListener onButtonTap {
      ...
      def createZygote = {
        ...
        val name = s"Atom Wallet Snapshot ${new Date}.txt"
        ...
        val fileURI = FileProvider.getUriForFile(me, "com.lightning.walletapp.bca", savedFile)
